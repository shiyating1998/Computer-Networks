...
class CSLRTopo( Topo ):
        ...
        def __init__( self ):
                ...
                h1 = self.addHost( 'Bob' )
                h2 = self.addHost( 'Carol' )

                # Add switches
                s0 = self.addSwitch( 'Robert', listenPort=6634 )
                s1 = self.addSwitch( 'Richard', listenPort=6635 )
                s2 = self.addSwitch( 'Rupert', listenPort=6636 )
...
def run():
        ...
        h0 = net.get( 'Alice' )
        h0.intf( 'h0-eth0' ).setIP( '10.1.1.17', 24 )
       ...
       # h1.intf( 'h1-eth0' ).setMAC( '0A:00:01:02:00:00' )
        ...
        h2 = net.get( 'Carol' )
        h2.intf( 'h2-eth0' ).setIP( '10.6.6.69', 24 )
